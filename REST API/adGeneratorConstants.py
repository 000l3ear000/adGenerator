epicDict = {
    ...
    "Template_2.webM": [[4, 4.7, 6, 6, 3.5], 1, [81, 253, 234], 920],

    "Template_3.webM": [[3.9, 4.6, 6, 6.5, 5.8], 1, [80, 252, 236], 960],
    "Template_4.webM": [[3.9, 4.6, 6, 6.5, 5.8], 1, [80, 252, 236], 998],

    "Template_5.webM": [[4.7, 6, 6.2, 4], 4.8, [71, 226, 211], 928],
    "Template_6.webM": [[4.7, 6, 6.2, 4], 4.8, [71, 226, 211], 928],
